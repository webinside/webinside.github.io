...
public class HTMLParserTokenManager implements HTMLParserConstants {
    ...
    {
        "", null, null, "\74\41\55\55", "\74\41", null, null, null, null, null,
        null, null, null, "\75", null, null, "\47", "\42", null, null, null,
        null, null, null, "\55\55\76", null, "\76",
    };
    /** DOCUMENT ME! */
    public static final String[] lexStateNames =
    {
        "DEFAULT", "WithinTag", "AfterEquals", "WithinQuote1", "WithinQuote2",
        "WithinComment1", "WithinComment2",
    };
    /** DOCUMENT ME! */
    public static final int[] jjnewLexState =
    {
        -1, 1, 1, 5, 6, -1, -1, -1, -1, -1, -1, -1, -1, 2, 0, 1, 3, 4, -1, -1, 1,
        -1, 1, -1, 0, -1, 0,
    };
    /** DOCUMENT ME! */
    ...
    private final int jjMoveNfa_4(int startState, int curPos) {
        ...
        for (;;) {
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (
                            startsAt = 2 - (jjnewStateCnt = startsAt)
                        )) {
                return curPos;
            }
            try {
    ...
    private final int jjMoveNfa_1(int startState, int curPos) {
        ...
        for (;;) {
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (
                            startsAt = 6 - (jjnewStateCnt = startsAt)
                        )) {
                return curPos;
            }
            try {
