 ...
 */
public class UploadFtp extends AbstractUpload {
    ...
    /**
     * Creates a new UploadFtp object.
     *
     * @param id DOCUMENT ME!
     */
    public UploadFtp(String id) {
        super(id);
        this.setType("FTP");
    }
     ...
     */
    public UploadFtp(String id, Element element) {
        super(id, element);
        this.setType("FTP");
    }
    ...
    public void setHostId(String value) {
        XMLFunction.setElemValue(this.upload, "HOSTID", value);
    }
    ...
    public String getHostId() {
        return XMLFunction.getElemValue(this.upload, "HOSTID");
    }
    ...
    public Document getTemplate() {
        if (template == null) {
            template = CompFunction.getTemplate("upload_ftp.xml");
        }
        return template;
    }
}
